...
def pgd(model, x, y, eps, max_iter, target): # pass the target label as parameter for the targeted attack
...
for i in range(num_attack):
    ...
    if pgd(model, x, y, eps, max_iter, target): num_adv += 1
